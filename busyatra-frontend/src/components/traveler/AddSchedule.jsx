 ...
 const handleSubmit = async (e) => {
  ...
  return (
    <div className="max-w-3xl mx-auto">
      <div className="mb-8">
        <h2 className="text-3xl font-bold text-white">Add <span className="text-primary">Schedule</span></h2>
        <p className="text-gray-500 mt-2">Plan a new journey for your fleet.</p>
      </div>

      <form onSubmit={handleSubmit} className="bg-[#12121c] rounded-2xl p-8 border border-white/5 shadow-2xl relative overflow-hidden">
        {/* Decorative elements */}
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-400 mb-1.5">Choose Vehicle</label>
              <select
                name="bus_id"
                required
              ...
              >
                <option value="" className="bg-[#12121c]">Select a bus...</option>
                {buses.map(bus => (
                  <option key={bus.bus_id} value={bus.bus_id} className="bg-[#12121c]">
              ...
              {selectedBus && (
                <div className="bg-primary/5 border border-primary/20 rounded-xl p-4 flex items-center justify-between text-sm">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <span className="text-gray-400 text-xs uppercase">Route</span>
                      <div className="flex items-center gap-2 font-medium text-white">
                        {selectedBus.from_location} <ArrowRight className="w-3 h-3 text-gray-500" /> {selectedBus.to_location}
                      </div>
                    </div>
                  </div>
          ...
          <div className="space-y-4 pt-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div>
                <label className="block text-sm font-medium text-gray-400 mb-1.5">Journey Date</label>
                <div className="relative">
                  <input
                    ...
                    value={formData.date}
                    onChange={handleChange}
                    className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white focus:ring-1 focus:ring-primary/50 outline-none transition appearance-none calendar-dark"
                  />
              ...
              <div>
                <label className="block text-sm font-medium text-gray-400 mb-1.5">Trip Fare (₹)</label>
                <div className="relative">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-400 mb-1.5">Departure Time</label>
                <div className="relative">
                  <input
                    type="time"
                    name="departure_time"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-400 mb-1.5">Arrival Time</label>
                <div className="relative">
                  <input
                    type="time"
                    name="arrival_time"
